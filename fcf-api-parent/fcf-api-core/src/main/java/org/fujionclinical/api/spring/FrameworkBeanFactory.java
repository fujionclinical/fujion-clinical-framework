 ...
 * <p>
 * The <b>fcf:override</b> attribute that can explicitly allow or disallow the overriding of a bean
 * definition, independent of the settings for the application context. It should be applied to the
 * overriding bean definition.
 * <p>
 * The <b>fcf:final</b> attribute that can prevent a bean definition from being overridden under any
 * circumstances. If set to true, it takes precedence over the application context settings and the
 * fcf:override setting of any overriding bean definition. The default attribute value is false.
 */
public class FrameworkBeanFactory extends DefaultListableBeanFactory {
    ...
    /**
     * Namespace handler registers the decorator for the fcf:override attribute.
     */
     ...
     * when no fcf:override attribute is specified.
     */
    @Override
     ...
     * bean. The override behavior is set to the fcf:override setting of the bean definition or, in
     * the absence of this setting, to the default override behavior for the bean factory and by the
     * fcf:final setting which can be used to prevent a bean declaration from ever being overridden.
     */
    @Override
