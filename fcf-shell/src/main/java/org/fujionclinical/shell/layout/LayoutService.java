...
public class LayoutService implements ILayoutService {
    ...
    private static final String PROPERTY_LAYOUT_SHARED = "FCF.LAYOUT.SHARED";

    private static final String PROPERTY_LAYOUT_PRIVATE = "FCF.LAYOUT.PRIVATE";

    private static final String PROPERTY_LAYOUT_ASSOCIATION = "FCF.LAYOUT.ASSOCIATION";
    ...
    private String getPropertyName(boolean shared) {
        return shared ? PROPERTY_LAYOUT_SHARED : PROPERTY_LAYOUT_PRIVATE;
    }
