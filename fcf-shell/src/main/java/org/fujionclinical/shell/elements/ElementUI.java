...
public abstract class ElementUI extends ElementBase {
    ...
    /**
     * Returns the UI element that registered the FCF component.
     *
     * @param component The FCF component of interest.
    ...
    /**
     * Create wrapped component(s) from a template (a fcf page). Performs autowiring of variables
     * and events. The template URL is derived from the class name. For example, if the class is
     * "org.fujionclinical.xxx.Clazz", the template URL is assumed to be
     * "web/org/fujionclinical/xxx/clazz.fsp".
     *
    ...
    /**
     * Create wrapped component(s) from specified template (a fcf page). Performs autowiring of
     * variables and events.
     *
     * @param template URL of fcf page that will serve as a template. If a path is not specified, it
    ...
    /**
     * Create wrapped component(s) from specified template (a fcf page).
     *
     * @param template URL of fcf page that will serve as a template. If the URL is not specified,
    ...
    protected BaseUIComponent createFromTemplate(String template, BaseComponent parent, Object controller) {
        ...
        try {
            ...
            FCFException.raise("Error creating element from template.", e);
        }
    ...
    /**
     * Associates the specified FCF component with this UI element.
     *
     * @param component FCF component to associate.
     */
    ...
    /**
     * Apply/remove the design context menu to/from FCF components. This default implementation
     * applies the design context menu to the outer FCF component only. It may be overridden to
