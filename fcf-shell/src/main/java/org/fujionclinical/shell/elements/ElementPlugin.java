...
public class ElementPlugin extends ElementUI implements IDisable, IPropertyAccessor {
    ...
    private class ToolbarContainer extends Namespace {
        ...
        public ToolbarContainer() {
            super();
            addClass("fcf-toolbar-container");
        }
    }
    ...
    public ElementPlugin() {
        super();
        shell = ShellUtil.getShell();
        setOuterComponent(container);
        setMaskMode(MaskMode.ENABLE);
        container.addClass("fcf-plugin-container");
        fullSize(container);
        container.wireController(this);
    }

    /**
     * @see org.fujionclinical.shell.elements.ElementBase#about()
     */
    @Override
    public void about() {
     ...
     * @see org.fujionclinical.shell.elements.ElementBase#afterInitialize
     */
    @Override
    ...
    public void setDefinition(PluginDefinition definition) {
        ...
        if (definition != null) {
            container.addClass("fcf-plugin-" + definition.getId());
    ...
    /**
     * Initializes a plugin, if not already done. This loads the plugin's principal fcf page,
