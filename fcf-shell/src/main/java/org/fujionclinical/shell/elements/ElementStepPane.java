...
public class ElementStepPane extends ElementUI {
     ...
     *
     * @see org.fujionclinical.shell.elements.ElementUI#bind
     */
    @Override
    protected void bind() {
        super.bind();
     ...
     *
     * @see org.fujionclinical.shell.elements.ElementUI#unbind
     */
    @Override
     ...
     *
     * @see org.fujionclinical.shell.elements.ElementUI#bringToFront()
     */
    @Override
     ...
     *
     * @see org.fujionclinical.shell.elements.ElementUI#getInstanceName()
     */
    @Override
     ...
     *
     * @see org.fujionclinical.shell.elements.ElementUI#applyColor()
     */
    @Override
