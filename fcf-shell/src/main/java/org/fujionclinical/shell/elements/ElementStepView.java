...
import org.fujionclinical.shell.designer.PropertyEditorStepView;
...
public class ElementStepView extends ElementUI {
    ...
    public void setActivePane(ElementStepPane pane) {
        ...
        btnHome.toggleClass(null, "fcf-stepview-home-selected", activePane == null || activePane.getIndex() != 0);
     ...
     *
     * @see org.fujionclinical.shell.elements.ElementBase#updateState()
     */
    @Override
    ...
    private void updateClass() {
        outer.toggleClass("fcf-stepview-nonav", null, noNavigation);
        outer.toggleClass("fcf-stepview-nohome", null, noHome);
    }
}
