...
public class PluginDefinition {
    ...
    /**
     * Returns the URL of the principal fcf page for the plugin.
     *
     * @return The URL of the principal fcf page.
     */
    ...
    /**
     * Sets the URL of the principal fcf page for the plugin.
     *
     * @param url The URL of the principal fcf page.
     */
     ...
     * @param propertyProvider Property source for initializing element properties (may be null).
     * @param deserializing If true, we are deserializing a layout.
    ...
    public ElementBase createElement(ElementBase parent, IPropertyProvider propertyProvider, boolean deserializing) {
        try {
            ...
            if (isForbidden()) {
                ...
                if (element == null) {
                    FCFException.raise("Failed to create UI element " + id + ".");
                }
