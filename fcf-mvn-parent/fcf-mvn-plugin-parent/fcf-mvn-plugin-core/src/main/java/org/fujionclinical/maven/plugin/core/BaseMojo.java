...
public abstract class BaseMojo extends AbstractMojo {
     ...
     * </p>
     */
    @Parameter(property = "maven.fujionclinical.mojo.warInclusion", defaultValue = "true", required = true)
    private boolean warInclusion;
    
    /**
     * Whether to fail build on error
     */
    @Parameter(property = "maven.fujionclinical.mojo.failOnError", defaultValue = "true", required = false)
