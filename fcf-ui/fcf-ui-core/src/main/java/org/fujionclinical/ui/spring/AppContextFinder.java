...
import org.fujionclinical.api.spring.IAppContextFinder;
...
public class AppContextFinder implements IAppContextFinder {
    ...
    protected static final String APP_CONTEXT_ATTRIB = "_FCFAppContext";
     ...
     *
     * @see org.fujionclinical.api.spring.IAppContextFinder#getChildAppContext()
     ...
     *
     * @see org.fujionclinical.api.spring.IAppContextFinder#getRootAppContext()
