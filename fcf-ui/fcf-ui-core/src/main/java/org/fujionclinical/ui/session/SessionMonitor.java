...
public class SessionMonitor extends FrameworkController {
    ...
    private static final String TIMEOUT_WARNING = "fcf.sessionmonitor.%.warning.message";
    
    private static final String TIMEOUT_EXPIRATION = "fcf.sessionmonitor.%.reason.message";
    
    private static final String SCLASS_COUNTDOWN = "fcf-sessionmonitor-%-countdown";
    
    private static final String SCLASS_IDLE = "fcf-sessionmonitor-%-idle";
    ...
    private final IEventSubscriber<Object> applicationControlListener = (eventName, eventData) -> {
    ...
    private void updateClass() {
        ...
        if (shutdown) {
            sclass += " fcf-sessionmonitor-shutdown";
        }
