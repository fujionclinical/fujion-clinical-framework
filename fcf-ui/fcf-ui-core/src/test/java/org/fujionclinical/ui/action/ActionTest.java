...
public class ActionTest {
    ...
    public void testActionFormats() {
        ...
        assertTrue(ActionTypeRegistry.getType("http://www.fujionclinical.org") instanceof ActionTypeUrl);
        assertTrue(ActionTypeRegistry.getType("https://www.fujionclinical.org") instanceof ActionTypeUrl);
