...
import org.fujionclinical.api.patient.list.AbstractPatientListFilter;

/**
 * Renderer for filters.
 */
public class PatientListFilterRenderer implements IComponentRenderer<Listitem, AbstractPatientListFilter> {

    /**
     * Render a list item.
     *
     * @param filter The associated patient list filter.
     * @return The rendered list item.
     */
    @Override
