...
public class PatientSelection {
     ...
     *            user.
     */
    public static void show(boolean changeContext, IResponseCallback<IPatient> callback) {
        if (canSelect(true)) {
    ...
    private static void execCallback(IResponseCallback<IPatient> callback, IPatient patient) {
        if (callback != null) {
     ...
     *            was canceled.
     */
    public static void selectFromList(List<IPatient> patientList, IResponseCallback<IPatient> callback) {
