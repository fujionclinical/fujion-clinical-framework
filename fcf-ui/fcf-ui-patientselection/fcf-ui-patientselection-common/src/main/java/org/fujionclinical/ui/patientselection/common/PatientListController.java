...
import org.fujionclinical.api.patient.list.IPatientList;
import org.fujionclinical.api.patient.list.IPatientListItem;
...
public class PatientListController extends FrameworkController {
    ...
    public void afterInitialized(BaseComponent comp) {
        ...
        Collection<IPatientListItem> items = plist.getListItems();
