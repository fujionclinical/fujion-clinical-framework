...
public class ContextManager implements IContextManager, CCOWContextManager.ICCOWContextEvent, IRegisterEvent {
    ...
    public void ccowJoin() {
        ...
        if (ccowContextManager == null && ccowEnabled) {
            ...
            ccowContextManager.run("FCF#", "", true, "*");
        }
    ...
    /**
     * @see org.fujionclinical.api.context.IContextManager#localChangeBegin
     */
    @Override
    ...
    /**
     * @see org.fujionclinical.api.context.IContextManager#localChangeEnd
     */
    @Override
    ...
    /**
     * @see org.fujionclinical.api.context.IContextManager#getSharedContexts
     */
    @Override
    public List<ISharedContext<?>> getSharedContexts() {
        return new ArrayList<>(managedContexts);
    }

    /**
     * @see org.fujionclinical.api.context.IContextManager#getSharedContext
     */
    @Override
    ...
    /**
     * @see org.fujionclinical.api.context.IContextManager#getContextMarshaller
     */
    @Override
    ...
    /**
     * @see org.fujionclinical.api.context.IContextManager#reset
     */
    @Override
