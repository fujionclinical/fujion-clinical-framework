...
public class AppFramework implements ApplicationContextAware, DestructionAwareBeanPostProcessor {
    ...
    public synchronized boolean registerObject(Object object) {
        if (!CollectionUtil.containsInstance(registeredObjects, object)) {
    ...
    public synchronized boolean unregisterObject(Object object) {
        int i = CollectionUtil.indexOfInstance(registeredObjects, object);
     ...
     */
    public synchronized Object findObject(
            Class<?> clazz,
            Object previousInstance) {
        int i = previousInstance == null ? -1 : CollectionUtil.indexOfInstance(registeredObjects, previousInstance);
