 ...
 * programmatically.
 */
public class AliasTypes extends AbstractRegistry<String, AliasType> implements ApplicationContextAware {

    private static final Log log = LogFactory.getLog(AliasTypes.class);

    private static final AliasTypes instance = new AliasTypes();
     ...
     */
    public static AliasTypes getInstance() {
        return instance;
    }
