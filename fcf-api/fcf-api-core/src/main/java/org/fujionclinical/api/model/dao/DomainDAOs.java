 ...
 */
public class DomainDAOs<T extends IDomainType> extends BeanRegistry<Class<T>, IDomainDAO<T>> {

    private static final DomainDAOs<?> instance = new DomainDAOs<>();

    public static <T extends IDomainType> DomainDAOs<T> getInstance() {
        return (DomainDAOs<T>) instance;
    }
