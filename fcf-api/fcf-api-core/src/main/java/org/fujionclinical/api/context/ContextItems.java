...
public class ContextItems {
    ...
    public void setDate(
        ...
        if (date == null) {
            ...
            setItem(itemName, DateUtil.toISODate(date));
        }
    }
    ...
    public void setDateTime(
        ...
        if (date == null) {
            ...
            setItem(itemName, DateUtil.toISODateTime(date));
        }
    }
    ...
    public LocalDate getDate(String itemName) {
        try {
            return LocalDate.parse(getItem(itemName));
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public LocalDateTime getDateTime(String itemName) {
        try {
            return LocalDateTime.parse(getItem(itemName));
        } catch (Exception e) {
            return null;
        }
    }
