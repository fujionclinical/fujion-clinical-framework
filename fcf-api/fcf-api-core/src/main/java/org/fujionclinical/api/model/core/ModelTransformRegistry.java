 ...
 */
public class ModelTransformRegistry extends BeanRegistry<Class<? extends IModelTransform>, IModelTransform> {

    private static final Logger log = Logger.create(ModelTransformRegistry.class);

    private static final ModelTransformRegistry instance = new ModelTransformRegistry();

    public static ModelTransformRegistry getInstance() {
        return instance;
    }

    private ModelTransformRegistry() {
