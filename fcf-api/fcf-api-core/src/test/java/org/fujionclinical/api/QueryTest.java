...
public class QueryTest {
    ...
    public void test() {
        ...
        Expression expression = ExpressionParser.getInstance().parse(IUser.class,
                "id=={{user.id}} & name.family ~ {{user.name.family}} & birthDate >= 1/27/2000 & race=system1|code1,code2,system3|code3,|code4" +
