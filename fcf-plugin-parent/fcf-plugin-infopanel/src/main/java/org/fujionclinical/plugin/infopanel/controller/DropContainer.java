...
public class DropContainer extends Window implements IActionTarget {
    ...
    private static final String SCLASS = "fcf-infopanel-container";
    
    private static final String TEMPLATE = "web/org/fujionclinical/plugin/infopanel/dropContainer.fsp";
