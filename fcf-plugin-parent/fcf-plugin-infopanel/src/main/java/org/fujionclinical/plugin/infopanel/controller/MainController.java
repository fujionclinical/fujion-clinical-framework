...
public class MainController extends PluginController implements IInfoPanel {
     ...
     * @see org.fujionclinical.plugin.infopanel.model.IInfoPanel#registerMenuItem(Menuitem,
     *      String)
     */
    @Override
     ...
     * @see org.fujionclinical.plugin.infopanel.model.IInfoPanel#unregisterMenuItem(Menuitem)
     */
    @Override
